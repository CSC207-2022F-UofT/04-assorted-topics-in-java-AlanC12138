...
public class Trader<T> {
    ...
    /* T-ODO: Add a new constructor that takes a single argument
    ...
    /* T-ODO: Implement the method addToWishlist that takes an
     *       object of type T and adds it to this Trader's wishlist.
     */
    public void addToWishlist(T wantedItem){
        this.wishlist.add(wantedItem);
    }

    /* T-ODO: Implement the method getSellingPrice that takes an
